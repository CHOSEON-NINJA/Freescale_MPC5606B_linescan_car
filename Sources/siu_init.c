...
void siu_portB_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[20].R = 0x2000;
             /* User Assigned Signal Name : TEST_RECIVER1  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[21].R = 0x2000;
             /* User Assigned Signal Name : CAMERA_VOUT_RECIVER  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[22].R = 0x2000;
             /* User Assigned Signal Name : TEST_RECIVER3  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[23].R = 0x2000;
             /* User Assigned Signal Name : TEST_RECIVER4  */
...
void siu_portE_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[68].R = 0x0201;
             /* User Assigned Signal Name : CAMERA_SI  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[69].R = 0x0201;
             /* User Assigned Signal Name : CAMERA_CLK  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[70].R = 0x0201;
             /* User Assigned Signal Name : DC_MOTOR_EN1  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[71].R = 0x0601;
             /* User Assigned Signal Name : DC_MOTOR_INPUT2  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[73].R = 0x0201;
             /* User Assigned Signal Name : PE9_OPWFMB_SERVO_PWM  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[75].R = 0x0601;
             /* User Assigned Signal Name : PE11_OPWFMB_DC_PWM  */
             /*	Selected Function : eMIOS_0_24 O          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
...
/*-----------------------------------------------------------*/
               SIU.PSMI[24].R = 0x01;
                /*Function Pad Selected eMIOS0_CH23 :- PCR73*/
